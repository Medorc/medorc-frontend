...
export default function DoctorProfile() {
  ...
  const getOrganization = async () => {
    try {
      const response = await axios.get(
        `${url}/api/v1/doctor/profile/organization`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          ...
          <div className="bg-white rounded-xl w-full max-w-7xl border border-gray-400 p-8 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
              <div className="flex flex-col gap-2">
                <label className="text-black font-medium">License Number:</label>
                <input
                  type="text"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-black font-medium">Year Of Experience:</label>
                <input
                  type="text"
                  className="border border-black rounded px-3 py-2 w-full"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-black font-medium">Hospital Affiliation:</label>
                <input
                  type="text"
                  className="border border-black rounded px-3 py-2 w-full"
              ...
              <div className="flex flex-col gap-2">
                <label className="text-black font-medium">Specialization:</label>
                <input
                  type="text"
                  className="border border-black rounded px-3 py-2 w-full"
