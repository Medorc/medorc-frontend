...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans pb-10">
            ...
            <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 pt-8">
                ...
                {/* TOP HEADER */}
                <div
                    className="flex flex-col md:flex-row justify-between items-center bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8 gap-4">
                    <div className="flex items-center gap-4 w-full md:w-auto">
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-sm">Welcome
                                back, {data.full_name?.split(" ")[0] || "Patient"}</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10 pt-12">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        {/* Hero / Welcome Card */}
                        <div
                            className="bg-gradient-to-br from-indigo-900 to-blue-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-xl">
                            <div
                                className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -translate-y-10 translate-x-10"></div>
                            <div
                                className="absolute bottom-0 left-0 w-48 h-48 bg-blue-500/20 rounded-full blur-2xl translate-y-10 -translate-x-10"></div>

                            <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6">
                                <div
                                    className="w-24 h-24 rounded-full border-4 border-white/20 shadow-xl overflow-hidden bg-white/10 shrink-0">
                                    <img
                                ...
                                <div className="text-center sm:text-left">
                                    ...
                                    <div className="flex flex-wrap justify-center sm:justify-start gap-4">
                                        <div
                                            className="bg-white/10 backdrop-blur-md px-4 py-2 rounded-lg border border-white/10 text-sm">
  ...
  {data.date_of_birth
      ...
      : "24 yrs"}
                        ...
                        {/* Health Tip */}
                        <div
                            className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6 min-h-[120px]">
                            <div className="p-4 bg-emerald-100 rounded-full text-emerald-600 shrink-0 animate-pulse">
                                <FiActivity size={32}/>
                            </div>
                            <div
                                className={`text-center md:text-left transition-opacity duration-500 ${fade ? 'opacity-100' : 'opacity-0'}`}>
                                <h3 className="text-lg font-bold text-emerald-900 mb-1">
                                    Daily Health Tip {healthTip?.category ? <span
                                    className="text-emerald-600 text-xs bg-emerald-100 px-2 py-0.5 rounded-full ml-2 uppercase">{healthTip.category}</span> : null}
                                </h3>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden relative">
                            <div className="bg-gray-900 p-6 text-white relative overflow-hidden">
                                <div
                                    className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
                                ...
                                <div className="mb-2">
                                    <p className="text-gray-400 text-xs uppercase tracking-widest mb-1 pt-2">SHC
                                        Code</p>
                    ...
                    <span className="font-bold text-gray-700 text-sm flex items-center gap-2">
                      {enabled ? <FiEye className="text-emerald-500"/> : <FiEyeOff className="text-gray-400"/>}
                        Doctor Access
                                        ...
                                        >
                                            <div
                                                className={`w-4 h-4 rounded-full bg-white shadow-sm transform transition-transform duration-300 ${enabled ? "translate-x-6" : "translate-x-0"}`}></div>
                                        </div>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        <p className="text-gray-600 leading-relaxed">
                                            <span
                                                className="font-semibold text-gray-900">Secure Health Card (SHC)</span> is
                                            your digital health passport. It acts as a unique identifier for your
                                            medical history.
                                        </p>
