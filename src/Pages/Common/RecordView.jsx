...
export default function RecordView() {
    ...
    return (
        <div className="flex flex-col items-center min-h-screen bg-gray-50 font-sans gap-26">
            <NavBar />

            <div className="flex flex-col w-full max-w-5xl bg-white rounded-xl shadow-sm mt-8 mb-12 p-10 relative border border-gray-100">
                {/* Close Button */}
                <button
                    onClick={() => navigate(-1)}
